...
**Django Framework Component**

```cmd
list of Django framework component separation of concern:
- front end technology (html, css, bootstrap, javascript)
- back end technology (django, javascript, database, scrapy, server, docker)
- model view url template architecture
- django admin
- super user

- django project
- django default application, in house application, and 3rd party application
...
- form handle on views
- custom validator

- session management
- session management with cookies
- django session framework and API
- session data on database
- user authentication
```
